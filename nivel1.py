...
def iniciar_nivel1(nome_usuario):
    ...
    tela_nivel1.bind("<Escape>", lambda event: tela_nivel1.attributes('-fullscreen', False))
    ...
    def finalizar_quiz():
        ...
        try:
            ...
            if casa == 10:
                ...
                img = img.resize((tela_nivel1.winfo_width(), tela_nivel1.winfo_height()))
